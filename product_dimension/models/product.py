...
class Material(models.Model):
    ...
    name = fields.Char(string="Denumire Material",required=True,help="Denumire Materialul intern")
    Prescurtare = fields.Char(string="Shortcut",required=True,help="Ex. la otel avem - OL, AL - aluminiu")
    densitate = fields.Float(string="Densitate",default=8,help="Kg/dm**3")
    AreFolie=fields.Boolean(string="Tick daca are folie")
...
class Product(models.Model):
    ...
    height = fields.Float()
    width = fields.Float()
    material_id = fields.Many2one('product.material','Material folosit')
