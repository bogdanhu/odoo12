...
class helpan_dosar(models.Model):
    ...
    #devize_ids = fields.One2many('product.template', 'dosar_id')  # sa am toate facturile aferente dosarului
...
class HrEmployee(models.Model):
    ...
    dosare_ids= fields.One2many('helpan.dosar', 'ResponsabilTehnic')
    facturat = fields.Float(string='Valoare Facturata fara TVA', compute='_get_sum_invoices')
